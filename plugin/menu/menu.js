...
var RevealMenu = window.RevealMenu || (function(){
	...
	loadResource(options.path + '/font-awesome-4.3.0/css/font-awesome.min.css', 'stylesheet', function() {
		...
		if (!bowser.msie || bowser.version >= 9) {
			...
			var buttons = 0;
			$('<li data-panel="Slides" data-button="' + (buttons++) + '" class="toolbar-panel-button"><span class="slide-menu-toolbar-label">Slajdy</span><br/><i class="fa fa-list"></i></li>')
				.appendTo(toolbar)
			...
			$('<li id="close"><span class="slide-menu-toolbar-label">Zamknij</span><br/><i class="fa fa-times"></i></li>')
				.appendTo(toolbar)
				.click(closeMenu);
